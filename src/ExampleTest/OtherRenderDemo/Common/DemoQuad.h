...
inline GeometryBufferRef CreateDemoQuad(ShaderProgramRef shader)
{
	struct Vert
	{
		glm::vec3 pos;
	...
	Vert vpoint[] = {
		// positions   // texCoords
		{{-0.99f,  0.99f, 0.0f}, {0.0f, 1.0f}},
		{{-0.99f, -0.99f, 0.0f}, {0.0f, 0.0f}},
		{{ 0.99f, -0.99f, 0.0f}, {1.0f, 0.0f}},
		{{ 0.99f,  0.99f, 0.0f}, {1.0f, 1.0f}}
	};
...
inline ShaderProgramRef CreateDemoQuadShader()
{
